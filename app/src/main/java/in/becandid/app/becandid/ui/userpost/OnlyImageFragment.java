 ...
 */
public class OnlyImageFragment extends BaseFragment implements OnLoadMoreListener, DiscoverTrendingMvpView {
    ...
    public OnlyImageFragment() {
        // Required empty public constructor
    }

    public static OnlyImageFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_LATEST_PAGE, page);
        OnlyImageFragment fragment = new OnlyImageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                try {
                    mPresenter.getImagePostsOnline(MySharedPreferences.getUserId(preferences),"true", String.valueOf(currentPage));
    ...
    public void onLoadMore() {
        if (response.size() == 25){
            try {
                ...
                mPresenter.getImagePostsOnline02(MySharedPreferences.getUserId(preferences),"true", String.valueOf(currentPage));
