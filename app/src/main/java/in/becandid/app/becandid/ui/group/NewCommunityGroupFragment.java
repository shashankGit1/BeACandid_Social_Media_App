 ...
 */
public class NewCommunityGroupFragment extends BaseFragment implements SwipeStack.SwipeStackListener, NewCommunityGroupMvpView {
    ...
    public NewCommunityGroupFragment() {
        // Required empty public constructor
    }

    @Inject
    NewCommunityGroupMvpPresenter<NewCommunityGroupMvpView> mPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeStack = (SwipeStack) view.findViewById(R.id.swipeStack_latest);
        ...
        progressFrame = view.findViewById(R.id.community_Fragment_frame_latest);
        ...
        try {
         ...
         //   mPresenter.getListUserJoinedGroups01(MySharedPreferences.getUserId(preferences), key_user_age , "0",currentPage);
            mPresenter.getLatestUserJoinedGroupsOnline(MySharedPreferences.getUserId(preferences), key_user_age , "0",currentPage);
            //     loadFirstPage();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    */
    ...
    public void onStackEmpty() {
        try {
            ...
            mPresenter.getLatestUserJoinedGroupsOnline02(MySharedPreferences.getUserId(preferences), key_user_age , "0",currentPage);
    ...
    @Override
    public void getLatestUserJoinedGroups(List<CommunityGroupPojoNew> response) {
//   progressBar.setVisibility(View.GONE);
        hideErrorView();
      ...
      //  mSwipeStack.resetStack();
        ...
        mSwipeStack.setListener(NewCommunityGroupFragment.this);
    ...
    @Override
    public void getLatestUserJoinedGroups02(List<CommunityGroupPojoNew> response) {
//   progressBar.setVisibility(View.GONE);
        hideErrorView();
        //   Log.e("RESPONSE:::", "Size===" + response.size());
        //         List<PostsModel> body = (List<PostsModel>) response.get(0).body();
