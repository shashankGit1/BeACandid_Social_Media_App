...
import in.becandid.app.becandid.payload.AppPayload;
import in.becandid.app.becandid.payload.LinkPayload;
import in.becandid.app.becandid.payload.Payload;
import in.becandid.app.becandid.payload.PingPayload;
import in.becandid.app.becandid.payload.RawPayload;
import in.becandid.app.becandid.payload.TextPayload;
    ...
    static class TextViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final Payload payload) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                //    intent.putExtra(Constants.receiverId, idusername);
                    Toast.makeText(view.getContext(), "cliked discover page", Toast.LENGTH_SHORT).show();

//                    view.getContext().startActivity(new Intent(view.getContext(), DiscoverActivity.class));
                 //   Intent intent = new Intent(view.getContext(), DiscoverActivity.class));
                   // intent.getStr
                   // Util.copyToClipboard(view.getContext(), ((TextPayload) payload).body);
                }
            });
        }
    }
