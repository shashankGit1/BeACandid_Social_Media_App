...
package in.becandid.app.becandid.chat_design.dialogs;
...
import in.becandid.app.becandid.chat_design.commons.ViewHolder;
import in.becandid.app.becandid.chat_design.commons.models.IDialog;
import in.becandid.app.becandid.chat_design.commons.models.IMessage;
import in.becandid.app.becandid.chat_design.utils.DateFormatter;
    ...
    * */
    ...
    public static class DialogViewHolder<DIALOG extends IDialog> extends BaseDialogViewHolder<DIALOG> {
        ...
        public void onBind(final DIALOG dialog) {
            ...
            /*
            add code here harsh
            Long datetime = Long.parseLong(dialog.getLastMessage().getCreatedAt());
