 ...
 */
public class DiscoverHistoryFragment extends BaseFragment implements OnLoadMoreListener, DiscoverHistoryMvpView {
    ...
    public DiscoverHistoryFragment() {
        // Required empty public constructor
    }

    @Inject
    DiscoverHistoryMvpPresenter<DiscoverHistoryMvpView> mPresenter;


    public static DiscoverHistoryFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_LATEST_PAGE, page);
        DiscoverHistoryFragment fragment = new DiscoverHistoryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_discover_history, container, false);
        ...
        progressFrame = view.findViewById(R.id.activity_discover_history);
            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            mPresenter.getHistoryPostsOnline(MySharedPreferences.getUserId(preferences),MySharedPreferences.getUserId(preferences),"true", currentPage);
        ...
        error_btn_retry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                 ...
                 //   getHistoryPosts(MySharedPreferences.getUserId(preferences),MySharedPreferences.getUserId(preferences),"true", currentPage);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private void showEmptyView() {
        if (no_post_layout.getVisibility() == View.GONE) {
            ...
            progressBar.setVisibility(View.GONE);
            no_post_textview.setText("You have not liked or Commented any Post");
        }
    }
  ...
  /*  @Override
    ...
    public void onLoadMore() {
        if (response.size() == 25){
            try {
                ...
                currentPage += 1;
                mPresenter.getHistoryPostsOnline02(MySharedPreferences.getUserId(preferences),MySharedPreferences.getUserId(preferences),"true", currentPage);
    ...
    @Override
    public void getHistoryPosts01(List<PostsModel> response) {
    ...
    @Override
    public void getHistoryPosts02(List<PostsModel> response) {
        progressFrame.setVisibility(View.GONE);
...
private void loadFirstPage() throws Exception {
        ...
        application.getWebService()
                .getHistoryFeed(MySharedPreferences.getUserId(preferences),MySharedPreferences.getUserId(preferences),"true", currentPage)
